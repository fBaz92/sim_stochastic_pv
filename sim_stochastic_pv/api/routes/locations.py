            ...
            if not samples:
                ...
                climate_data = {
                    ...
                    "notes": (
                        ...
                        f"Fitted warming trend = "
                        f"{report.fitted_trend_c_per_year:+.3f} °C/year"
                        f"{' (model uses an explicit override)' if payload.climate_trend_c_per_year is not None else ''}. "
