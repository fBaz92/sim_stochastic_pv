...
class PanelCurvePoint(BaseModel):
    """One I-V / P-V curve of the panel product sheet."""
...
class PanelCurvesResponse(BaseModel):
    """
    Product-sheet curve families for a catalogue panel.

    Two families generated by the single-diode model fitted on the
    panel's datasheet specs: irradiance sweep at 25 degC cell and
    temperature sweep at 1000 W/m2.
    """

    panel_id: int
    name: str
    irradiance_family: List[PanelCurvePoint]
    temperature_family: List[PanelCurvePoint]
